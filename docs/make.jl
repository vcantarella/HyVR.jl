...
DocMeta.setdocmeta!(HyVR, :DocTestSetup, :(using HyVR); recursive = true)
...
makedocs(;
    modules = [HyVR],
    authors = "Vitor Cantarella vcantarella@gmail.com",
    repo = "https://github.com/vcantarella/HyVR.jl/blob/{commit}{path}#{line}",
    sitename = "HyVR.jl",
    format = Documenter.HTML(; canonical = "https://vcantarella.github.io/HyVR.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/vcantarella/HyVR.jl")
